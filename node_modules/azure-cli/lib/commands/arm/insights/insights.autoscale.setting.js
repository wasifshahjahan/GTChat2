...
exports.init = function(cli) {
  ...
  insightsAutoscaleSettingCommand.command("set <resourceGroup>").description($("Create or set an autoscale setting.")).usage("[options] <resourceGroup>").option("-x --disable", $("Flag to disable the setting.")).option("-a --autoProfiles <autoProfiles>", $("A list of autoscale profiles in JSON format.")).option("-g --resourceGroup <resourceGroup>", $("The resource group.")).option("-n --settingName <settingName>", $("The name of the setting.")).option("-l --location <location>", $("The location.")).option("-i --targetResourceId <targetResourceId>", $("The resource Id.")).option("-p --settingSpec <settingSpec>", $("The setting spec in JSON format.")).execute(function __3(resourceGroup, options, _) { var __frame = { name: "__3", line: 67 }; return __func(_, this, arguments, __3, 2, __frame, function __$__3() {
      ...
      return insightsAutoscaleSettingCommand._prepareAndExecuteSet(resourceGroup, options, __cb(_, __frame, 1, 38, function __$__3() { _(); }, true)); }); });


  insightsAutoscaleSettingCommand._prepareAndExecute = function insightsAutoscaleSettingCommand__prepareAndExecute__4(resourceGroup, options, _) { var client, __this = this; var __frame = { name: "insightsAutoscaleSettingCommand__prepareAndExecute__4", line: 71 }; return __func(_, this, arguments, insightsAutoscaleSettingCommand__prepareAndExecute__4, 2, __frame, function __$insightsAutoscaleSettingCommand__prepareAndExecute__4() {
      ...
      return __this._executeCmd(client, resourceGroup, options.settingName, options, __cb(_, __frame, 7, 9, function __$insightsAutoscaleSettingCommand__prepareAndExecute__4() { _(); }, true)); }); };


  insightsAutoscaleSettingCommand._prepareAndExecuteDelete = function insightsAutoscaleSettingCommand__prepareAndExecuteDelete__5(resourceGroup, settingName, options, _) { var client, __this = this; var __frame = { name: "insightsAutoscaleSettingCommand__prepareAndExecuteDelete__5", line: 81 }; return __func(_, this, arguments, insightsAutoscaleSettingCommand__prepareAndExecuteDelete__5, 3, __frame, function __$insightsAutoscaleSettingCommand__prepareAndExecuteDelete__5() {
      if (!__.isString(resourceGroup)) {
        cli.missingArgument("resourceGroup"); } ;
  ...
  insightsAutoscaleSettingCommand._prepareAndExecuteSet = function insightsAutoscaleSettingCommand__prepareAndExecuteSet__6(resourceGroup, options, _) { var client, parameters, __this = this; var __frame = { name: "insightsAutoscaleSettingCommand__prepareAndExecuteSet__6", line: 95 }; return __func(_, this, arguments, insightsAutoscaleSettingCommand__prepareAndExecuteSet__6, 2, __frame, function __$insightsAutoscaleSettingCommand__prepareAndExecuteSet__6() {
      client = insightsUtils.createInsightsManagementClient(log, options);
      parameters = __this._createSdkCallParameters(options.settingName, options.location, resourceGroup, options.targetResourceId, options);
      log.silly(util.inspect(parameters));

      return __this._executeSetCmd(client, resourceGroup, options.settingName, parameters, options, __cb(_, __frame, 5, 9, function __$insightsAutoscaleSettingCommand__prepareAndExecuteSet__6() { _(); }, true)); }); };
  ...
  insightsAutoscaleSettingCommand._executeCmd = function insightsAutoscaleSettingCommand__executeCmd__7(client, resourceGroup, settingName, options, _) { var progress, result, response; var __frame = { name: "insightsAutoscaleSettingCommand__executeCmd__7", line: 203 }; return __func(_, this, arguments, insightsAutoscaleSettingCommand__executeCmd__7, 4, __frame, function __$insightsAutoscaleSettingCommand__executeCmd__7() {
      ...
      result = []; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$insightsAutoscaleSettingCommand__executeCmd__7() { return (function __$insightsAutoscaleSettingCommand__executeCmd__7(__then) {
              ...
              if (((__.isNull(settingName) || __.isUndefined(settingName)) || ((__.isString(settingName) && (settingName === ""))))) {
                ...
                return client.autoscaleOperations.getSetting(resourceGroup, settingName, __cb(_, __frame, 16, 46, function ___(__0, __2) { response = __2;
  ...
  insightsAutoscaleSettingCommand._executeSetCmd = function insightsAutoscaleSettingCommand__executeSetCmd__9(client, resourceGroup, settingName, parameters, options, _) { var progress, response; var __frame = { name: "insightsAutoscaleSettingCommand__executeSetCmd__9", line: 247 }; return __func(_, this, arguments, insightsAutoscaleSettingCommand__executeSetCmd__9, 5, __frame, function __$insightsAutoscaleSettingCommand__executeSetCmd__9() {
