...
exports.init = function(cli) {
  ...
  availset.command("create [resource-group] [name] [location] [tags]").description($("Creates an availability set within a resource group")).usage("[options] <resource-group> <name> <location> [tags]").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the availability set name")).option("-l, --location <location>", $("the location")).option("-t, --tags <tags>", $("the semicolon separated list of tags")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __1(resourceGroup, name, location, tags, options, _) { var availsetClient; var __frame = { name: "__1", line: 21 }; return __func(_, this, arguments, __1, 5, __frame, function __$__1() {
  ...
  availset.command("list [resource-group]").description($("Lists the availability sets within a resource group")).usage("[options] <resource-group>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, options, _) { var availsetClient; var __frame = { name: "__2", line: 34 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
  ...
  availset.command("show [resource-group] [name]").description($("Gets one availability set within a resource group")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resourceGroup>", $("the resource group name")).option("-n, --name <name>", $("the availability set name")).option("-d, --depth <depth>", $("the number of times to recurse, to recurse indefinitely pass \"full\". (valid only with --json option)")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __3(resourceGroup, name, options, _) { var availsetClient; var __frame = { name: "__3", line: 47 }; return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
