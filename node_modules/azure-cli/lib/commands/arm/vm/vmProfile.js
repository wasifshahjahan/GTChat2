...
__.extend(VMProfile.prototype, {
                          ...
                          if ((((stoInfo !== null) && stoInfo.profile) && stoInfo.profile.storageAccount)) {
                            ...
                            if ((((stoProfile !== null) && stoProfile.primaryEndpoints) && stoProfile.primaryEndpoints.blob)) {
                              ...
                              for (itemKey in storageUtil.AccountTypeForChanging) {
                                if ((storageUtil.AccountTypeForChanging[itemKey] === stoProfile.accountType)) {
                                  foundElem = true;
                                ...
                                if (!foundElem) {
                                  ...
                                  return vmStorageProfile._generateNewStorageAccountNameWithPrefix("", __cb(_, __frame, 68, 51, function ___(__0, __7) { bootStorageName = __7;
                                    createRequestProfile = {
                                      accountType: "Standard_LRS",
                                      name: bootStorageName,
                                      location: __this.params.location };

                                    return __this.serviceClients.storageManagementClient.storageAccounts.create(__this.resourceGroupName, bootStorageName, createRequestProfile, __cb(_, __frame, 74, 72, function __$generateVMProfile__1() {
                                      return vmStorageProfile._findStorageAccount(bootStorageName, __cb(_, __frame, 75, 50, function ___(__0, __8) { bootStoProfile = __8;
                                        __this.params.bootDiagnosticsStorageUri = bootStoProfile.storageAccount.primaryEndpoints.blob; __then(); }, true)); }, true)); }, true)); } else {
  ...
  updateVMProfile: function updateVMProfile__2(virtualMachine, _) { var vmNetworkProfile, validNICs, vmHardwareProfile, vmDiagnosticsProfile, diagnosticsProfileResult, __this = this; var __frame = { name: "updateVMProfile__2", line: 145 }; return __func(_, this, arguments, updateVMProfile__2, 1, __frame, function __$updateVMProfile__2() {
  ...
  _parseVMProfileParams: function _parseVMProfileParams__3(params, _) { var vmProfile, __this = this; var __frame = { name: "_parseVMProfileParams__3", line: 198 }; return __func(_, this, arguments, _parseVMProfileParams__3, 1, __frame, function __$_parseVMProfileParams__3() { return (function __$_parseVMProfileParams__3(__then) {
        if (!params.location) {
