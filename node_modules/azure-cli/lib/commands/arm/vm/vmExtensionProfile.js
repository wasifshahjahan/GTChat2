...
__.extend(VMExtensionProfile.prototype, {
  ...
  _createDiagPrivateConfiguration: function _createDiagPrivateConfiguration__5(_) { var config, keys, __this = this; var __frame = { name: "_createDiagPrivateConfiguration__5", line: 1103 }; return __func(_, this, arguments, _createDiagPrivateConfiguration__5, 0, __frame, function __$_createDiagPrivateConfiguration__5() {
      config = {
  ...
  _createAemConfiguration: function() {
    ...
    publicConfig["osdisk.name"] = this.params.osDisk.name;
    ...
    for (var i = 0; (i < this.params.dataDisks.length); i++) {
      var dataDisk = this.params.dataDisks[i];
      ...
      publicConfig[("disk.name." + i)] = dataDisk.name;
      ...
      if ((saProperties.type === "Premium")) {
        ...
        publicConfig[("disk.connminute." + i)] = (dataDisk.name + ".minute");
  ...
  _generateDockerClientCertificates: function _generateDockerClientCertificates__12(dockerCertPaths, password, _) { var configPath, __this = this; var __frame = { name: "_generateDockerClientCertificates__12", line: 1594 }; return __func(_, this, arguments, _generateDockerClientCertificates__12, 2, __frame, function __$_generateDockerClientCertificates__12() {
