...
exports.init = function(cli) {
  ...
  vm.command("list [resourceGroup]").description($("Get all virtual machines in a resource group")).usage("[options] <resource-group>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __3(resourceGroup, options, _) { var vmClient; var __frame = { name: "__3", line: 174 }; return __func(_, this, arguments, __3, 2, __frame, function __$__3() {
  ...
  vm.command("show [resource-group] [name]").description($("Get a virtual machine in a resource group")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-d, --depth <depth>", $("the number of times to recurse, to recurse indefinitely pass \"full\". (valid only with --json option)")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__4", line: 186 }; return __func(_, this, arguments, __4, 3, __frame, function __$__4() {
  ...
  vm.command("stop [resource-group] [name]").description($("Shutdown a virtual machine in a resource group")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __6(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__6", line: 213 }; return __func(_, this, arguments, __6, 3, __frame, function __$__6() {
  ...
  vm.command("restart [resource-group] [name]").description($("Restart a virtual machine in a resource group")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __7(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__7", line: 226 }; return __func(_, this, arguments, __7, 3, __frame, function __$__7() {
  ...
  vm.command("start [resource-group] [name]").description($("Start a virtual machine in a resource group")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __8(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__8", line: 239 }; return __func(_, this, arguments, __8, 3, __frame, function __$__8() {
  ...
  vm.command("deallocate [resource-group] [name]").description($("Shutdown a virtual machine in a resource group and release the compute resources")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __9(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__9", line: 252 }; return __func(_, this, arguments, __9, 3, __frame, function __$__9() {
  ...
  vm.command("generalize [resource-group] [name]").description($("Set the state of a VM in a resource group to Generalized.")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __12(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__12", line: 297 }; return __func(_, this, arguments, __12, 3, __frame, function __$__12() {
  ...
  vm.command("list-usage [location]").description($("Get usage of compute resources.")).usage("[options] <location>").option("-l, --location <location>", $("the location")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __18(location, options, _) { var vmClient; var __frame = { name: "__18", line: 398 }; return __func(_, this, arguments, __18, 2, __frame, function __$__18() {
  ...
  vm.command("show-disk-encryption-status [resource-group] [name]").description($("Show azure disk encryption status of a VM in a resource group.")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --name <name>", $("the virtual machine name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __21(resourceGroup, name, options, _) { var vmClient; var __frame = { name: "__21", line: 453 }; return __func(_, this, arguments, __21, 3, __frame, function __$__21() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 40, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Virtual machine name: "), vmName, __cb(_, __frame, 2, 33, function ___(__0, __2) { vmName = __2;
          return cli.interaction.promptIfNotGiven($("Disk size in gb: "), size, __cb(_, __frame, 3, 31, function ___(__0, __3) { size = __3;
            vmClient = new VMClient(cli, options.subscription);
            return vmClient.attachNewDataDisk(resourceGroup, vmName, size, vhdName, options, __cb(_, __frame, 5, 17, function __$__22() { _(); }, true)); }, true)); }, true)); }, true)); }); });


  disk.command("detach [resource-group] [vm-name] [lun]").description($("Detach a data-disk attached to a VM in a resource group")).usage("[options] <resource-group> <vm-name> <lun>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --vm-name <vm-name>", $("the virtual machine name")).option("-l, --lun <lun>", $("the data disk lun")).option("-s, --subscription <id>", $("the subscription id")).execute(function __23(resourceGroup, vmName, lun, options, _) { var vmClient; var __frame = { name: "__23", line: 490 }; return __func(_, this, arguments, __23, 4, __frame, function __$__23() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 40, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Virtual machine name: "), vmName, __cb(_, __frame, 2, 33, function ___(__0, __2) { vmName = __2;
          return cli.interaction.promptIfNotGiven($("URL of existing VHD: "), vhdUrl, __cb(_, __frame, 3, 33, function ___(__0, __3) { vhdUrl = __3;
            ...
            vmClient = new VMClient(cli, options.subscription);
            return vmClient.attachDataDisk(resourceGroup, vmName, vhdUrl, options, __cb(_, __frame, 6, 17, function __$__24() { _(); }, true)); }, true)); }, true)); }, true)); }); });


  disk.command("list [resource-group] [vm-name]").description($("Get all data disks of a VM in a resource group")).usage("[options] <resource-group> <vm-name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-n, --vm-name <vm-name>", $("the virtual machine name")).option("-s, --subscription <id>", $("the subscription id")).execute(function __25(resourceGroup, vmName, vhdUrl, options, _) { var vmClient; var __frame = { name: "__25", line: 523 }; return __func(_, this, arguments, __25, 4, __frame, function __$__25() {
  ...
  extension.command("set-chef [resource-group] [vm-name]").description($("Enable/disable chef extension for a VM in a resource group")).usage("[options] <resource-group> <vm-name> ").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-m, --vm-name <vm-name>", $("the virtual machine name")).option("-o, --version <version>", $("the extension version")).option("-R, --run-list <run-list>", $("Runlist of roles/recipes to apply to VM")).option("-O, --validation-pem <validation-pem>", $("chef validation pem file path. Not required if -C or --client-pem option specified")).option("-c, --client-config <client-config>", $("chef client configuration file(i.e client.rb) path")).option("-C, --client-pem <client-pem>", $("chef client pem file path i.e required in validator less bootstrap")).option("-a, --auto-update-client", $("auto update chef client")).option("-j, --bootstrap-options <bootstrap-json-attribute>", $("Bootstrap options in JSON format. Ex: -j '{\"chef_node_name\":\"test_node\"}'")).option("-D, --delete-chef-config", $("delete chef config files during update/uninstall extension")).option("-u, --uninstall", $("uninstall extension")).option("-t, --tags <tags>", $(("Tags to set to the resource group. Can be multiple. " + "In the format of 'name=value'. Name is required and value is optional. For example, -t tag1=value1;tag2"))).option("-q, --quiet", $("quiet mode, do not ask for uninstall confirmation")).option("-s, --subscription <id>", $("the subscription id")).execute(function __27(resourceGroup, vmName, options, _) { var vmClient; var __frame = { name: "__27", line: 581 }; return __func(_, this, arguments, __27, 3, __frame, function __$__27() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 40, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Virtual machine name: "), vmName, __cb(_, __frame, 2, 33, function ___(__0, __2) { vmName = __2;
          vmClient = new VMClient(cli, options.subscription);
          return vmClient.setChefExtension(resourceGroup, vmName, options, __cb(_, __frame, 4, 17, function __$__27() { _(); }, true)); }, true)); }, true)); }); });


  extension.command("get [resource-group] [vm-name]").description($("Get extensions installed on a virtual machine in a resource group")).usage("[options] <resource-group> <vm-name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-m, --vm-name <vm-name>", $("the virtual machine name")).option("-s, --subscription <id>", $("the subscription id")).execute(function __28(resourceGroup, vmName, options, _) { var vmClient; var __frame = { name: "__28", line: 594 }; return __func(_, this, arguments, __28, 3, __frame, function __$__28() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 40, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Virtual machine name: "), vmName, __cb(_, __frame, 2, 33, function ___(__0, __2) { vmName = __2;
          ...
          vmClient = new VMClient(cli, options.subscription);
          return vmClient.getExtensions(resourceGroup, vmName, options, __cb(_, __frame, 5, 17, function __$__28() { _(); }, true)); }, true)); }, true)); }); });


  extension.command("get-chef [resource-group] [vm-name]").description($("Get chef extension installed on a virtual machine in a resource group")).usage("[options] <resource-group> <vm-name>").option("-g, --resource-group <resource-group>", $("the resource group name")).option("-m, --vm-name <vm-name>", $("the virtual machine name")).option("-s, --subscription <id>", $("the subscription id")).execute(function __29(resourceGroup, vmName, options, _) { var vmClient; var __frame = { name: "__29", line: 608 }; return __func(_, this, arguments, __29, 3, __frame, function __$__29() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 40, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Virtual machine name: "), vmName, __cb(_, __frame, 2, 33, function ___(__0, __2) { vmName = __2;
          ...
          vmClient = new VMClient(cli, options.subscription);
          return vmClient.getChefExtension(resourceGroup, vmName, options, __cb(_, __frame, 5, 17, function __$__29() { _(); }, true)); }, true)); }, true)); }); });


  var extensionImage = vm.category("extension-image").description($("Commands to query available VM resource extensions"));


  extensionImage.command("list-publishers [location]").description($("Lists virtual machine/extension image publishers")).usage("[options] <location>").option("-l, --location <location>", $("the location")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __30(location, options, _) { var vmClient; var __frame = { name: "__30", line: 624 }; return __func(_, this, arguments, __30, 2, __frame, function __$__30() {
      ...
      return cli.interaction.promptIfNotGiven($("Location: "), location, __cb(_, __frame, 1, 35, function ___(__0, __1) { location = __1;
        location = utils.toLowerCaseAndRemoveSpace(location);
        vmClient = new VMClient(cli, options.subscription);
        return vmClient.listVMImagePublishers(location, options, __cb(_, __frame, 4, 17, function __$__30() { _(); }, true)); }, true)); }); });


  extensionImage.command("list-types [location] [publisher]").description($("Lists virtual machine extension image types by a publisher")).usage("[options] <location> <publisher>").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __31(location, publisher, options, _) { var vmClient; var __frame = { name: "__31", line: 637 }; return __func(_, this, arguments, __31, 3, __frame, function __$__31() {
      ...
      return cli.interaction.promptIfNotGiven($("Location: "), location, __cb(_, __frame, 1, 35, function ___(__0, __1) { location = __1;
        return cli.interaction.promptIfNotGiven($("Publisher: "), publisher, __cb(_, __frame, 2, 36, function ___(__0, __2) { publisher = __2;
          location = utils.toLowerCaseAndRemoveSpace(location);
          vmClient = new VMClient(cli, options.subscription);
          return vmClient.listVMExtensionImageTypes(location, publisher, options, __cb(_, __frame, 5, 17, function __$__31() { _(); }, true)); }, true)); }, true)); }); });


  extensionImage.command("list-versions [location] [publisher] [typeName]").description($("Lists virtual machine extension image versions by publisher and type input")).usage("[options] <location> <publisher> <typeName>").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-t, --typeName <typeName>", $("the type name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __32(location, publisher, typeName, options, _) { var vmClient; var __frame = { name: "__32", line: 652 }; return __func(_, this, arguments, __32, 4, __frame, function __$__32() {
      ...
      return cli.interaction.promptIfNotGiven($("Location: "), location, __cb(_, __frame, 1, 35, function ___(__0, __1) { location = __1;
        return cli.interaction.promptIfNotGiven($("Publisher: "), publisher, __cb(_, __frame, 2, 36, function ___(__0, __2) { publisher = __2;
          return cli.interaction.promptIfNotGiven($("TypeName: "), typeName, __cb(_, __frame, 3, 35, function ___(__0, __3) { typeName = __3;
            location = utils.toLowerCaseAndRemoveSpace(location);
            vmClient = new VMClient(cli, options.subscription);
            return vmClient.listVMExtensionImageVersions(location, publisher, typeName, options, __cb(_, __frame, 6, 17, function __$__32() { _(); }, true)); }, true)); }, true)); }, true)); }); });


  extensionImage.command("list [location] [publisher] [typeName]").description($("Lists virtual machine extension images by publisher, and type input")).usage("[options] <location> <publisher> <typeName>").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-t, --typeName <typeName>", $("the type name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __33(location, publisher, typeName, options, _) { var vmClient; var __frame = { name: "__33", line: 668 }; return __func(_, this, arguments, __33, 4, __frame, function __$__33() {
      ...
      return cli.interaction.promptIfNotGiven($("Location: "), location, __cb(_, __frame, 1, 35, function ___(__0, __1) { location = __1;
        location = utils.toLowerCaseAndRemoveSpace(location);
        vmClient = new VMClient(cli, options.subscription);
        return vmClient.listVMExtensionImages(location, publisher, typeName, options, __cb(_, __frame, 4, 17, function __$__33() { _(); }, true)); }, true)); }); });


  extensionImage.command("show [location] [publisher] [typeName] [version]").description($("Lists virtual machine extension image versions by publisher, type and version input")).usage("[options] <location> <publisher> <typeName> <version>").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-t, --typeName <typeName>", $("the type name")).option("-v, --version <version>", $("the version")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __34(location, publisher, typeName, version, options, _) { var vmClient; var __frame = { name: "__34", line: 683 }; return __func(_, this, arguments, __34, 5, __frame, function __$__34() {
        ...
        return cli.interaction.promptIfNotGiven($("Publisher: "), publisher, __cb(_, __frame, 2, 36, function ___(__0, __2) { publisher = __2;
          return cli.interaction.promptIfNotGiven($("typeName: "), typeName, __cb(_, __frame, 3, 35, function ___(__0, __3) { typeName = __3;
            return cli.interaction.promptIfNotGiven($("version: "), version, __cb(_, __frame, 4, 34, function ___(__0, __4) { version = __4;
              location = utils.toLowerCaseAndRemoveSpace(location);
              vmClient = new VMClient(cli, options.subscription);
              return vmClient.getVMExtensionImage(location, publisher, typeName, version, options, __cb(_, __frame, 7, 17, function __$__34() { _(); }, true)); }, true)); }, true)); }, true)); }, true)); }); });
        ...
        return cli.interaction.promptIfNotGiven($("Virtual machine name: "), name, __cb(_, __frame, 2, 31, function ___(__0, __2) { name = __2;
          return cli.interaction.promptIfNotGiven($("Location name: "), location, __cb(_, __frame, 3, 35, function ___(__0, __3) { location = __3;
            return cli.interaction.promptIfNotGiven($("Operating system Type: "), osType, __cb(_, __frame, 4, 33, function ___(__0, __4) { osType = __4;
              location = utils.toLowerCaseAndRemoveSpace(location);
              vmClient = new VMClient(cli, options.subscription);
              return vmClient.createDockerVM(resourceGroup, name, location, osType, options, __cb(_, __frame, 7, 17, function __$__35() { _(); }, true)); }, true)); }, true)); }, true)); }, true)); }); });


  var image = vm.category("image").description($("Commands to manage VM images"));


  image.command("list-publishers [location]").description($("Lists virtual machines image publishers")).usage("[options] <location>").option("-l, --location <location>", $("the location")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __36(location, options, _) { var vmClient; var __frame = { name: "__36", line: 787 }; return __func(_, this, arguments, __36, 2, __frame, function __$__36() {
      ...
      return cli.interaction.promptIfNotGiven($("Location: "), location, __cb(_, __frame, 1, 35, function ___(__0, __1) { location = __1;
        location = utils.toLowerCaseAndRemoveSpace(location);
        vmClient = new VMClient(cli, options.subscription);
        return vmClient.listVMImagePublishers(location, options, __cb(_, __frame, 4, 17, function __$__36() { _(); }, true)); }, true)); }); });


  image.command("list-offers [location] [publisher]").description($("Lists virtual machines image offers by a publisher")).usage("[options] <location> <publisher>").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __37(location, publisher, options, _) { var vmClient; var __frame = { name: "__37", line: 800 }; return __func(_, this, arguments, __37, 3, __frame, function __$__37() {
      ...
      return cli.interaction.promptIfNotGiven($("Location: "), location, __cb(_, __frame, 1, 35, function ___(__0, __1) { location = __1;
        return cli.interaction.promptIfNotGiven($("Publisher: "), publisher, __cb(_, __frame, 2, 36, function ___(__0, __2) { publisher = __2;
          location = utils.toLowerCaseAndRemoveSpace(location);
          vmClient = new VMClient(cli, options.subscription);
          return vmClient.listVMImageOffers(location, publisher, options, __cb(_, __frame, 5, 17, function __$__37() { _(); }, true)); }, true)); }, true)); }); });


  image.command("list-skus [location] [publisher] [offer]").description($("Lists virtual machines image skus for a specific offer from a publisher")).usage("[options] <location> <publisher> <offer>").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-o, --offer <offer>", $("the offer")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __38(location, publisher, offer, options, _) { var vmClient; var __frame = { name: "__38", line: 815 }; return __func(_, this, arguments, __38, 4, __frame, function __$__38() {
      ...
      return cli.interaction.promptIfNotGiven($("Location: "), location, __cb(_, __frame, 1, 35, function ___(__0, __1) { location = __1;
        return cli.interaction.promptIfNotGiven($("Publisher: "), publisher, __cb(_, __frame, 2, 36, function ___(__0, __2) { publisher = __2;
          return cli.interaction.promptIfNotGiven($("Offer: "), offer, __cb(_, __frame, 3, 32, function ___(__0, __3) { offer = __3;
            location = utils.toLowerCaseAndRemoveSpace(location);
            vmClient = new VMClient(cli, options.subscription);
            return vmClient.listVMImageSkus(location, publisher, offer, options, __cb(_, __frame, 6, 17, function __$__38() { _(); }, true)); }, true)); }, true)); }, true)); }); });


  image.command("list [location] [publisher] [offer] [sku]").description($("Lists the virtual machines images")).usage("[options] <location> <publisher> [offer] [sku]").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-o, --offer <offer>", $("the offer")).option("-k, --sku <sku>", $("the sku")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __39(location, publisher, offer, sku, options, _) { var vmClient, params; var __frame = { name: "__39", line: 832 }; return __func(_, this, arguments, __39, 5, __frame, function __$__39() {
      ...
      return cli.interaction.promptIfNotGiven($("Location: "), location, __cb(_, __frame, 1, 35, function ___(__0, __1) { location = __1;
        return cli.interaction.promptIfNotGiven($("Publisher: "), publisher, __cb(_, __frame, 2, 36, function ___(__0, __2) { publisher = __2;
          ...
          return vmClient.listVMImages(params, options, __cb(_, __frame, 12, 17, function __$__39() { _(); }, true)); }, true)); }, true)); }); });


  image.command("show [location] [publisher] [offer] [sku] [version]").description($("Lists the virtual machines images")).usage("[options] <location> <publisher> [offer] [sku]").option("-l, --location <location>", $("the location")).option("-p, --publisher <publisher>", $("the publisher name")).option("-o, --offer <offer>", $("the offer")).option("-k, --sku <sku>", $("the sku")).option("-e, --version <version>", $("the version")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __40(location, publisher, offer, sku, version, options, _) { var vmClient, params; var __frame = { name: "__40", line: 856 }; return __func(_, this, arguments, __40, 6, __frame, function __$__40() {
          ...
          return cli.interaction.promptIfNotGiven($("Offer: "), offer, __cb(_, __frame, 3, 32, function ___(__0, __3) { offer = __3;
            return cli.interaction.promptIfNotGiven($("Sku: "), sku, __cb(_, __frame, 4, 30, function ___(__0, __4) { sku = __4;
              return cli.interaction.promptIfNotGiven($("Version: "), version, __cb(_, __frame, 5, 34, function ___(__0, __5) { version = __5;
                ...
                return vmClient.getVMImageDetails(params, options, __cb(_, __frame, 16, 17, function __$__40() { _(); }, true)); }, true)); }, true)); }, true)); }, true)); }, true)); }); });};
