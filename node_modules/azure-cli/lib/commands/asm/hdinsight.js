...
var UserInteractor = function(cli) {
  ...
  function promptIfNotGiven(message, value, _) { var __frame = { name: "promptIfNotGiven", line: 95 }; return __func(_, this, arguments, promptIfNotGiven, 2, __frame, function __$promptIfNotGiven() {
...
var ExecutionProcessor = function(cli) {
  ...
  this.createCluster = function createCluster__1(regionCloudServiceName, clusterName, clusterCreationPayload, _) { var hdInsight, result; var __frame = { name: "createCluster__1", line: 141 }; return __func(_, this, arguments, createCluster__1, 3, __frame, function __$createCluster__1() {
      hdInsight = self.createHDInsightClusterManagementClient(regionCloudServiceName);
      return hdInsight.clusterManagement.create(clusterName, clusterCreationPayload, __cb(_, __frame, 2, 45, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.createCluster2 = function createCluster2__2(regionCloudServiceName, clusterName, clusterCreationPayload, _) { var hdInsight2, result; var __frame = { name: "createCluster2__2", line: 147 }; return __func(_, this, arguments, createCluster2__2, 3, __frame, function __$createCluster2__2() {
      hdInsight2 = self.createHDInsightCluster2ManagementClient(regionCloudServiceName);
      return hdInsight2.clusterManagement.create(clusterName, clusterCreationPayload, __cb(_, __frame, 2, 46, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.getCluster = function getCluster__3(regionCloudServiceName, clusterName, _) { var hdInsight, result; var __frame = { name: "getCluster__3", line: 153 }; return __func(_, this, arguments, getCluster__3, 2, __frame, function __$getCluster__3() {
      hdInsight = self.createHDInsightClusterManagementClient(regionCloudServiceName);
      return hdInsight.clusterManagement.get(clusterName, __cb(_, __frame, 2, 45, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.getCluster2 = function getCluster2__4(regionCloudServiceName, clusterName, _) { var hdInsight2, result; var __frame = { name: "getCluster2__4", line: 159 }; return __func(_, this, arguments, getCluster2__4, 2, __frame, function __$getCluster2__4() {
      hdInsight2 = self.createHDInsightCluster2ManagementClient(regionCloudServiceName);
      return hdInsight2.clusterManagement.get(clusterName, __cb(_, __frame, 2, 46, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.deleteCluster = function deleteCluster__5(regionCloudServiceName, clusterName, _) { var hdInsight, result; var __frame = { name: "deleteCluster__5", line: 165 }; return __func(_, this, arguments, deleteCluster__5, 2, __frame, function __$deleteCluster__5() {
      hdInsight = self.createHDInsightClusterManagementClient(regionCloudServiceName);
      return hdInsight.clusterManagement.deleteMethod(clusterName, __cb(_, __frame, 2, 45, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.deleteCluster2 = function deleteCluster2__6(regionCloudServiceName, clusterName, _) { var hdInsight2, result; var __frame = { name: "deleteCluster2__6", line: 171 }; return __func(_, this, arguments, deleteCluster2__6, 2, __frame, function __$deleteCluster2__6() {
      hdInsight2 = self.createHDInsightCluster2ManagementClient(regionCloudServiceName);
      return hdInsight2.clusterManagement.deleteMethod(clusterName, __cb(_, __frame, 2, 46, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.listClusters = function listClusters__7(credentials, _) { var hdInsight, result; var __frame = { name: "listClusters__7", line: 177 }; return __func(_, this, arguments, listClusters__7, 1, __frame, function __$listClusters__7() {
      hdInsight = self.createHDInsightClusterManagementClient("cloudServiceName");
      return hdInsight.clusterManagement.list(__cb(_, __frame, 2, 45, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.listClusters2 = function listClusters2__8(credentials, _) { var hdInsight2, result; var __frame = { name: "listClusters2__8", line: 183 }; return __func(_, this, arguments, listClusters2__8, 1, __frame, function __$listClusters2__8() {
      hdInsight2 = self.createHDInsightCluster2ManagementClient("cloudServiceName");
      return hdInsight2.clusterManagement.list(__cb(_, __frame, 2, 46, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };
  ...
  this.submitHDInsightHiveJob = function submitHDInsightHiveJob__9(clusterDnsName, userName, password, parameters, _) { var hdInsightJobClient, result; var __frame = { name: "submitHDInsightHiveJob__9", line: 193 }; return __func(_, this, arguments, submitHDInsightHiveJob__9, 4, __frame, function __$submitHDInsightHiveJob__9() {
      hdInsightJobClient = self.createHDInsightJobManagementClient(clusterDnsName, userName, password);

      return hdInsightJobClient.jobManagement.submitHiveJob(parameters, __cb(_, __frame, 3, 50, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.submitHDInsightPigJob = function submitHDInsightPigJob__10(clusterDnsName, userName, password, parameters, _) { var hdInsightJobClient, result; var __frame = { name: "submitHDInsightPigJob__10", line: 200 }; return __func(_, this, arguments, submitHDInsightPigJob__10, 4, __frame, function __$submitHDInsightPigJob__10() {
      hdInsightJobClient = self.createHDInsightJobManagementClient(clusterDnsName, userName, password);
      return hdInsightJobClient.jobManagement.submitPigJob(parameters, __cb(_, __frame, 2, 50, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.submitHDInsightMapReduceJob = function submitHDInsightMapReduceJob__11(clusterDnsName, userName, password, parameters, _) { var hdInsightJobClient, result; var __frame = { name: "submitHDInsightMapReduceJob__11", line: 206 }; return __func(_, this, arguments, submitHDInsightMapReduceJob__11, 4, __frame, function __$submitHDInsightMapReduceJob__11() {
      hdInsightJobClient = self.createHDInsightJobManagementClient(clusterDnsName, userName, password);
      return hdInsightJobClient.jobManagement.submitMapReduceJob(parameters, __cb(_, __frame, 2, 50, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.submitHDInsightStreamingMapReduceJob = function submitHDInsightStreamingMapReduceJob__12(clusterDnsName, userName, password, parameters, _) { var hdInsightJobClient, result; var __frame = { name: "submitHDInsightStreamingMapReduceJob__12", line: 212 }; return __func(_, this, arguments, submitHDInsightStreamingMapReduceJob__12, 4, __frame, function __$submitHDInsightStreamingMapReduceJob__12() {
      hdInsightJobClient = self.createHDInsightJobManagementClient(clusterDnsName, userName, password);
      return hdInsightJobClient.jobManagement.submitMapReduceStreamingJob(parameters, __cb(_, __frame, 2, 50, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.getHDInsightJob = function getHDInsightJob__13(clusterDnsName, userName, password, jobId, _) { var hdInsightJobClient, result; var __frame = { name: "getHDInsightJob__13", line: 218 }; return __func(_, this, arguments, getHDInsightJob__13, 4, __frame, function __$getHDInsightJob__13() {
      hdInsightJobClient = self.createHDInsightJobManagementClient(clusterDnsName, userName, password);
      return hdInsightJobClient.jobManagement.getJob(jobId, __cb(_, __frame, 2, 50, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.listHDInsightJobs = function listHDInsightJobs__14(clusterDnsName, userName, password, _) { var hdInsightJobClient, result; var __frame = { name: "listHDInsightJobs__14", line: 224 }; return __func(_, this, arguments, listHDInsightJobs__14, 3, __frame, function __$listHDInsightJobs__14() {
      hdInsightJobClient = self.createHDInsightJobManagementClient(clusterDnsName, userName, password);
      return hdInsightJobClient.jobManagement.listJobs(__cb(_, __frame, 2, 50, function ___(__0, __1) { result = __1;
...
var hdInsightCommandLine = function(cli, userInteractor, executionProcessor) {
  ...
  this.createClusterCommand = function createClusterCommand__1(clusterName, osType, storageAccountName, storageAccountKey, storageContainer, dataNodeCount, headNodeSize, dataNodeSize, location, userName, password, sshUserName, sshPassword, _) { var clusterCreationPayload, clusterPayload, subscriptionId, cluster2Payload, regionCloudServiceName, result; var __frame = { name: "createClusterCommand__1", line: 249 }; return __func(_, this, arguments, createClusterCommand__1, 13, __frame, function __$createClusterCommand__1() {
  ...
  this.showClusterCommand = function showClusterCommand__2(clusterName, osType, options, _) { var regionCloudServiceName, cluster, clusterInfo; var __frame = { name: "showClusterCommand__2", line: 302 }; return __func(_, this, arguments, showClusterCommand__2, 3, __frame, function __$showClusterCommand__2() {
  ...
  this.listClustersCommand = function listClustersCommand__3(options, _) { var result, clusters; var __frame = { name: "listClustersCommand__3", line: 337 }; return __func(_, this, arguments, listClustersCommand__3, 1, __frame, function __$listClustersCommand__3() {
  ...
  this.deleteClusterCommand = function deleteClusterCommand__4(clusterName, location, osType, options, _) { var regionCloudServiceName; var __frame = { name: "deleteClusterCommand__4", line: 382 }; return __func(_, this, arguments, deleteClusterCommand__4, 4, __frame, function __$deleteClusterCommand__4() {
      return self.user.promptIfNotGiven($("Cluster name: "), clusterName, __cb(_, __frame, 1, 28, function ___(__0, __1) { clusterName = __1;
  ...
  this.submitHDInsightHiveJobCommand = function submitHDInsightHiveJobCommand__5(clusterDnsName, userName, password, options, _) { var parameters, result, response; var __frame = { name: "submitHDInsightHiveJobCommand__5", line: 400 }; return __func(_, this, arguments, submitHDInsightHiveJobCommand__5, 4, __frame, function __$submitHDInsightHiveJobCommand__5() {
  ...
  this.submitHDInsightPigJobCommand = function submitHDInsightPigJobCommand__6(clusterDnsName, userName, password, options, _) { var parameters, result, response; var __frame = { name: "submitHDInsightPigJobCommand__6", line: 441 }; return __func(_, this, arguments, submitHDInsightPigJobCommand__6, 4, __frame, function __$submitHDInsightPigJobCommand__6() {
      return self.user.promptIfNotGiven($("Cluster name: "), clusterDnsName, __cb(_, __frame, 1, 31, function ___(__0, __1) { clusterDnsName = __1;
        return self.user.promptIfNotGiven($("User name: "), userName, __cb(_, __frame, 2, 25, function ___(__0, __2) { userName = __2;
          return self.user.promptIfNotGiven($("Password: "), password, __cb(_, __frame, 3, 25, function ___(__0, __3) { password = __3;
            parameters = { };
  ...
  this.submitHDInsightMapReduceJobCommand = function submitHDInsightMapReduceJobCommand__7(clusterDnsName, userName, password, options, _) { var parameters, result, response; var __frame = { name: "submitHDInsightMapReduceJobCommand__7", line: 476 }; return __func(_, this, arguments, submitHDInsightMapReduceJobCommand__7, 4, __frame, function __$submitHDInsightMapReduceJobCommand__7() {
      return self.user.promptIfNotGiven($("Cluster name: "), clusterDnsName, __cb(_, __frame, 1, 31, function ___(__0, __1) { clusterDnsName = __1;
        return self.user.promptIfNotGiven($("User name: "), userName, __cb(_, __frame, 2, 25, function ___(__0, __2) { userName = __2;
          return self.user.promptIfNotGiven($("Password: "), password, __cb(_, __frame, 3, 25, function ___(__0, __3) { password = __3;
            parameters = { };
  ...
  this.getHDInsightJobCommand = function getHDInsightJobCommand__9(clusterDnsName, userName, password, jobId, _) { var result, jobInfo; var __frame = { name: "getHDInsightJobCommand__9", line: 566 }; return __func(_, this, arguments, getHDInsightJobCommand__9, 4, __frame, function __$getHDInsightJobCommand__9() {
      return self.user.promptIfNotGiven($("Cluster name: "), clusterDnsName, __cb(_, __frame, 1, 31, function ___(__0, __1) { clusterDnsName = __1;
        return self.user.promptIfNotGiven($("User name: "), userName, __cb(_, __frame, 2, 25, function ___(__0, __2) { userName = __2;
          return self.user.promptIfNotGiven($("Password: "), password, __cb(_, __frame, 3, 25, function ___(__0, __3) { password = __3;
  ...
  this.listHDInsightJobsCommand = function listHDInsightJobsCommand__10(clusterDnsName, userName, password, _) { var jobList; var __frame = { name: "listHDInsightJobsCommand__10", line: 592 }; return __func(_, this, arguments, listHDInsightJobsCommand__10, 3, __frame, function __$listHDInsightJobsCommand__10() {
      return self.user.promptIfNotGiven($("Cluster name: "), clusterDnsName, __cb(_, __frame, 1, 31, function ___(__0, __1) { clusterDnsName = __1;
        return self.user.promptIfNotGiven($("User name: "), userName, __cb(_, __frame, 2, 25, function ___(__0, __2) { userName = __2;
          return self.user.promptIfNotGiven($("Password: "), password, __cb(_, __frame, 3, 25, function ___(__0, __3) { password = __3;
...
hdInsightCommandLine.init = function(cli) {
  ...
  cluster.command("show [clusterName] [osType]").description($("Show cluster details")).usage("[options] <clusterName> <osType>").option("--clusterName <clusterName>", $("the HdInsight cluster name")).option("--osType <osType>", $("the HdInsight cluster operating system: windows OR linux")).option("-s, --subscription <id>", $("the subscription id")).execute(self.showClusterCommand);
  ...
  cluster.command("list").description($("List the clusters")).execute(self.listClustersCommand);
