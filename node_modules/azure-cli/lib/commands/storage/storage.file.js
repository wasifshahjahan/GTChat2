...
exports.init = function(cli) {
                ...
                startProgress(util.format($("Checking file or directory '%s' in share %s"), (path ? path : ""), share)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$uploadFile() { return (function __$uploadFile(__then) {
                        ...
                        if (path) {
                          ...
                          file = result.basename; return (function __$uploadFile(_) {
                            ...
                            return performStorageOperation(getStorageFileOperation(fileService, "doesFileExist"), __cb(_, __frame, 42, 10, _, true), share, directory, file, storageOptions); })(__cb(_, __frame, -750, 18, function ___(__0, __9) { return (function __$uploadFile(__then) { if (__9) {
                                ...
                                remoteFileExists = true; __then(); } else { return (function __$uploadFile(_) {
                                  ...
                                  var __2 = pathIsDirectory; if (__2) { return _(null, __2); } ; return performStorageOperation(getStorageFileOperation(fileService, "doesDirectoryExist"), __cb(_, __frame, 54, 36, _, true), share, path); })(__cb(_, __frame, -750, 18, function ___(__0, __10) { return (function __$uploadFile(__then) { if (__10) {
                                      ...
                                      return performStorageOperation(getStorageFileOperation(fileService, "doesDirectoryExist"), __cb(_, __frame, 65, 17, function ___(__0, __11) { return (function __$uploadFile(__then) { if (__11) { __then(); } else {
                          ...
                          var __3 = remoteFileExists; if (__3) { return _(null, __3); } ; return performStorageOperation(getStorageFileOperation(fileService, "doesFileExist"), __cb(_, __frame, 87, 30, _, true), share, directory, file, storageOptions); })(__cb(_, __frame, -750, 18, function ___(__0, __12) { return (function __$uploadFile(__then) { if (__12) {
                      ...
                      if ((remoteFileExists === true)) { return (function __$uploadFile(__then) {
                          if ((force !== true)) {
                            return interaction.confirm(util.format($("Do you want to overwrite remote file %s? "), pathUtil.join(directory, file)), __cb(_, __frame, 102, 28, function ___(__0, __13) { force = __13;
                      ...
                      succeeded = false; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$uploadFile() {
                            ...
                            return performStorageOperation(getStorageFileOperation(fileService, "createFileFromLocalFile"), __cb(_, __frame, 124, 25, function ___(__0, __14) { uploadFileResult = __14;
  ...
  function doesStorageFileExist(share, path, options, _) { var fileService, storageOptions, propertiesOperation, result; var __frame = { name: "doesStorageFileExist", line: 1007 }; return __func(_, this, arguments, doesStorageFileExist, 3, __frame, function __$doesStorageFileExist() {
      ...
      return performStorageOperation(propertiesOperation, __cb(_, __frame, 8, 11, _, true), share, result.dirname, result.basename, storageOptions); }); };
  ...
  function startFileCopy(sourceUri, destShare, options, _) { var startCopyParams; var __frame = { name: "startFileCopy", line: 1081 }; return __func(_, this, arguments, startFileCopy, 3, __frame, function __$startFileCopy() {
      ...
      return StorageUtil.startAsyncCopy(startCopyParams, sourceUri, destShare, options, __cb(_, __frame, 4, 16, function __$startFileCopy() { _(); }, true)); }); };
