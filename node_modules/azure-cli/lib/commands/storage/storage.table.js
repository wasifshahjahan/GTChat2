...
exports.init = function(cli) {
  ...
  function createTable(table, options, _) { var tableService, operation, tips, storageOptions, created; var __frame = { name: "createTable", line: 205 }; return __func(_, this, arguments, createTable, 2, __frame, function __$createTable() {
  ...
  function deleteTable(table, options, _) { var tableService, operation, tips, storageOptions; var __frame = { name: "deleteTable", line: 232 }; return __func(_, this, arguments, deleteTable, 2, __frame, function __$deleteTable() {
      tableService = getTableServiceClient(options);
      return interaction.promptIfNotGiven($("Table name: "), table, __cb(_, __frame, 2, 24, function ___(__0, __1) { table = __1;
  ...
  function showTable(table, options, _) { var tableService, operation, tips, storageOptions, output, exist, info, acl; var __frame = { name: "showTable", line: 268 }; return __func(_, this, arguments, showTable, 2, __frame, function __$showTable() {
      tableService = getTableServiceClient(options);
      return interaction.promptIfNotGiven($("Table name: "), table, __cb(_, __frame, 2, 24, function ___(__0, __1) { table = __1;
        ...
        startProgress(tips); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$showTable() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$showTable() {
                    ...
                    return performStorageOperation(operation, __cb(_, __frame, 10, 18, function ___(__0, __2) { exist = __2; return (function __$showTable(__then) {
                        if (!exist) {
            ...
            cli.interaction.formatOutput(output[0], function(outputData) {
              if ((outputData.policies.length === 0)) {
                ...
                logger.table(outputData.policies, function(row, item) {
                  ...
                  row.cell($("Expiry"), (item.AccessPolicy.Expiry ? item.AccessPolicy.Expiry.toUTCFormat(UTCFormat) : "")); }); } ; }); _(); }); }); }, true)); }); };
  ...
  function listTable(prefix, options, _) { var tableService, listOperation, tips, tableOptions, useWildcard, tables; var __frame = { name: "listTable", line: 322 }; return __func(_, this, arguments, listTable, 2, __frame, function __$listTable() {
      tableService = getTableServiceClient(options);
      ...
      startProgress(tips); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$listTable() {
            ...
            return performStorageOperation(listOperation, __cb(_, __frame, 18, 6, function ___(__0, __2) { return __2.forEach_(__cb(_, __frame, 18, 62, function __$listTable() { _(null, null, true); }, true), StorageUtil.opConcurrency, function __1(_, table) { var info; var __frame = { name: "__1", line: 340 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
  ...
  function createTableSAS(table, permissions, expiry, options, _) { var tableService, start, tableField, output, sharedAccessPolicy, tips; var __frame = { name: "createTableSAS", line: 365 }; return __func(_, this, arguments, createTableSAS, 4, __frame, function __$createTableSAS() {
      tableService = getTableServiceClient(options);
          ...
          if (!options.policy) {
            return interaction.promptIfNotGiven($("Permissions: "), permissions, __cb(_, __frame, 5, 32, function ___(__0, __2) { permissions = __2;
              ...
              return interaction.promptIfNotGiven($("Expiry: "), expiry, __cb(_, __frame, 8, 27, function ___(__0, __3) { expiry = __3;
                expiry = validation.parseDateTime(expiry); __then(); }, true)); }, true)); } else { __then(); } ; })(function __$createTableSAS() {
  ...
  function createTablePolicy(table, name, options, _) { var createPolicySettings, policies; var __frame = { name: "createTablePolicy", line: 421 }; return __func(_, this, arguments, createTablePolicy, 3, __frame, function __$createTablePolicy() {
  ...
  function listTablePolicy(table, options, _) { var listPolicySettings, policies; var __frame = { name: "listTablePolicy", line: 441 }; return __func(_, this, arguments, listTablePolicy, 2, __frame, function __$listTablePolicy() {
  ...
  function showTablePolicy(table, name, options, _) { var showPolicySettings, policy; var __frame = { name: "showTablePolicy", line: 459 }; return __func(_, this, arguments, showTablePolicy, 3, __frame, function __$showTablePolicy() {
  ...
  function setTablePolicy(table, name, options, _) { var setPolicySettings, policies; var __frame = { name: "setTablePolicy", line: 474 }; return __func(_, this, arguments, setTablePolicy, 3, __frame, function __$setTablePolicy() {
  ...
  function deleteTablePolicy(table, name, options, _) { var deletePolicySettings, policies; var __frame = { name: "deleteTablePolicy", line: 494 }; return __func(_, this, arguments, deleteTablePolicy, 3, __frame, function __$deleteTablePolicy() {
