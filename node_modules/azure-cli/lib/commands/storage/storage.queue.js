...
exports.init = function(cli) {
  ...
  function createQueue(queue, options, _) { var queueService, operation, tips, storageOptions, created; var __frame = { name: "createQueue", line: 202 }; return __func(_, this, arguments, createQueue, 2, __frame, function __$createQueue() {
  ...
  function deleteQueue(queue, options, _) { var queueService, operation, tips, storageOptions; var __frame = { name: "deleteQueue", line: 228 }; return __func(_, this, arguments, deleteQueue, 2, __frame, function __$deleteQueue() {
      queueService = getQueueServiceClient(options);
      return interaction.promptIfNotGiven($("Queue name: "), queue, __cb(_, __frame, 2, 24, function ___(__0, __1) { queue = __1;
  ...
  function showQueue(queue, options, _) { var queueService, operation, tips, storageOptions, output, exist, info; var __frame = { name: "showQueue", line: 264 }; return __func(_, this, arguments, showQueue, 2, __frame, function __$showQueue() {
      queueService = getQueueServiceClient(options);
      return interaction.promptIfNotGiven($("Queue name: "), queue, __cb(_, __frame, 2, 24, function ___(__0, __1) { queue = __1;
        ...
        startProgress(tips); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$showQueue() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$showQueue() {
                    ...
                    return performStorageOperation(operation, __cb(_, __frame, 10, 18, function ___(__0, __2) { exist = __2; return (function __$showQueue(__then) {
                        if (!exist) {
  ...
  function listQueue(prefix, options, _) { var queueService, listOperation, tips, queueOptions, useWildcard, queues; var __frame = { name: "listQueue", line: 328 }; return __func(_, this, arguments, listQueue, 2, __frame, function __$listQueue() {
      queueService = getQueueServiceClient(options);
      ...
      startProgress(tips); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$listQueue() {
            ...
            return performStorageOperation(listOperation, __cb(_, __frame, 18, 6, function ___(__0, __2) { return __2.forEach_(__cb(_, __frame, 18, 62, function __$listQueue() { _(null, null, true); }, true), StorageUtil.opConcurrency, function __1(_, queue) { var info; var __frame = { name: "__1", line: 346 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
  ...
  function createQueueSAS(queue, permissions, expiry, options, _) { var queueService, start, output, sharedAccessPolicy, tips; var __frame = { name: "createQueueSAS", line: 371 }; return __func(_, this, arguments, createQueueSAS, 4, __frame, function __$createQueueSAS() {
      queueService = getQueueServiceClient(options);
          ...
          if (!options.policy) {
            return interaction.promptIfNotGiven($("Permissions: "), permissions, __cb(_, __frame, 5, 32, function ___(__0, __2) { permissions = __2;
              ...
              return interaction.promptIfNotGiven($("Expiry: "), expiry, __cb(_, __frame, 8, 27, function ___(__0, __3) { expiry = __3;
                expiry = validation.parseDateTime(expiry); __then(); }, true)); }, true)); } else { __then(); } ; })(function __$createQueueSAS() {
  ...
  function createQueuePolicy(queue, name, options, _) { var createPolicySettings, policies; var __frame = { name: "createQueuePolicy", line: 419 }; return __func(_, this, arguments, createQueuePolicy, 3, __frame, function __$createQueuePolicy() {
  ...
  function listQueuePolicy(queue, options, _) { var listPolicySettings, policies; var __frame = { name: "listQueuePolicy", line: 439 }; return __func(_, this, arguments, listQueuePolicy, 2, __frame, function __$listQueuePolicy() {
  ...
  function showQueuePolicy(queue, name, options, _) { var showPolicySettings, policy; var __frame = { name: "showQueuePolicy", line: 457 }; return __func(_, this, arguments, showQueuePolicy, 3, __frame, function __$showQueuePolicy() {
  ...
  function setQueuePolicy(queue, name, options, _) { var setPolicySettings, policies; var __frame = { name: "setQueuePolicy", line: 472 }; return __func(_, this, arguments, setQueuePolicy, 3, __frame, function __$setQueuePolicy() {
  ...
  function deleteQueuePolicy(queue, name, options, _) { var deletePolicySettings, policies; var __frame = { name: "deleteQueuePolicy", line: 492 }; return __func(_, this, arguments, deleteQueuePolicy, 3, __frame, function __$deleteQueuePolicy() {
