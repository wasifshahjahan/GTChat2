...
StorageUtil.performStorageOperation = function StorageUtil_performStorageOperation__1(storageOperation, _) { var service, operation, definedParameterCount, operationArgs, result, __arguments = arguments; var __frame = { name: "StorageUtil_performStorageOperation__1", line: 350 }; return __func(_, this, arguments, StorageUtil_performStorageOperation__1, 1, __frame, function __$StorageUtil_performStorageOperation__1() {
    ...
    result = null; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$StorageUtil_performStorageOperation__1() {
          ...
          return restFunnel(__cb(_, __frame, 19, 4, __then, true), function __1(_) { var __frame = { name: "__1", line: 369 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
...
StorageUtil.createPolicy = function StorageUtil_createPolicy__2(policySettings, _) { var __frame = { name: "StorageUtil_createPolicy__2", line: 879 }; return __func(_, this, arguments, StorageUtil_createPolicy__2, 1, __frame, function __$StorageUtil_createPolicy__2() {
...
StorageUtil.setPolicy = function StorageUtil_setPolicy__3(policySettings, _) { var __frame = { name: "StorageUtil_setPolicy__3", line: 888 }; return __func(_, this, arguments, StorageUtil_setPolicy__3, 1, __frame, function __$StorageUtil_setPolicy__3() {
...
StorageUtil.deletePolicy = function StorageUtil_deletePolicy__4(policySettings, _) { var __frame = { name: "StorageUtil_deletePolicy__4", line: 897 }; return __func(_, this, arguments, StorageUtil_deletePolicy__4, 1, __frame, function __$StorageUtil_deletePolicy__4() {
...
StorageUtil.selectPolicy = function StorageUtil_selectPolicy__5(policySettings, _) { var policies, index, i; var __frame = { name: "StorageUtil_selectPolicy__5", line: 907 }; return __func(_, this, arguments, StorageUtil_selectPolicy__5, 1, __frame, function __$StorageUtil_selectPolicy__5() {
    policies = [];
    index = -1;
    StorageUtil.startProgress(policySettings.tips); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$StorageUtil_selectPolicy__5() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$StorageUtil_selectPolicy__5() {
                ...
                return StorageUtil.performStorageOperation(policySettings.getAclOperation, __cb(_, __frame, 5, 27, function ___(__0, __1) { policies = __1.signedIdentifiers;
                  ...
                  return _(new Error((util.format($("%s\rReason: %s"), e.message, e.reason)))); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, function __$StorageUtil_selectPolicy__5() { _(null, null, true); }); }); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$StorageUtil_selectPolicy__5() {
...
function operateOnPolicy(policySettings, operation, _) { var policies, newPolicy; var __frame = { name: "operateOnPolicy", line: 983 }; return __func(_, this, arguments, operateOnPolicy, 2, __frame, function __$operateOnPolicy() {
    policies = [];
    StorageUtil.startProgress(policySettings.tips); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$operateOnPolicy() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$operateOnPolicy() {
                ...
                return StorageUtil.performStorageOperation(policySettings.getAclOperation, __cb(_, __frame, 4, 27, function ___(__0, __1) { policies = __1.signedIdentifiers;
                  ...
                  return _(new Error((util.format($("%s\rReason: %s"), e.message, e.reason)))); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, function __$operateOnPolicy() { _(null, null, true); }); }); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$operateOnPolicy() {
...
StorageUtil.startAsyncCopy = function StorageUtil_startAsyncCopy__6(startCopyParams, sourceUri, destContainerOrShare, options, _) { var isCopyToBlob, source, sourceContainerOrShare, sourceBlobOrFile, embeddedSas, sourceResource, index, sasToken, destBlobOrFile, destOption, destServiceClient, startOperation, tips, copyOp, retry, error, filePath, result; var __frame = { name: "StorageUtil_startAsyncCopy__6", line: 1369 }; return __func(_, this, arguments, StorageUtil_startAsyncCopy__6, 4, __frame, function __$StorageUtil_startAsyncCopy__6() {
    ...
    return getSourceUri(startCopyParams.copyType, options, __cb(_, __frame, 4, 15, function ___(__0, __2) { source = __2;
      ...
      return getSourceSASToken(startCopyParams, sourceContainerOrShare, sourceBlobOrFile, embeddedSas, options, __cb(_, __frame, 39, 17, function ___(__0, __3) { sasToken = __3;
        ...
        return cli.interaction.promptIfNotGiven((isCopyToBlob ? $("Destination container name: ") : $("Destination share name: ")), destContainerOrShare, __cb(_, __frame, 53, 41, function ___(__0, __4) { destContainerOrShare = __4;
          ...
          StorageUtil.startProgress(tips); return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$StorageUtil_startAsyncCopy__6() { __more = false;
              var __13 = ((retry === true) || (retry === undefined)); if (__13) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$StorageUtil_startAsyncCopy__6() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$StorageUtil_startAsyncCopy__6() {


                            if ((((retry === undefined) && !options.quiet) && isCopyToBlob)) {
                              startOperation.options.accessConditions = { "if-none-match": "*" }; }
                             else {
                              startOperation.options.accessConditions = { }; } ; return (function __$StorageUtil_startAsyncCopy__6(__then) {


                              if (isCopyToBlob) {
                                retry = false;
                                return StorageUtil.performStorageOperation(startOperation.operation, __cb(_, __frame, 82, 29, function ___(__0, __7) { copyOp = __7; __then(); }, true), source, destContainerOrShare, destBlobOrFile, startOperation.options); } else { return (function __$StorageUtil_startAsyncCopy__6(_) {

                                  var __1 = ((retry === undefined) && !options.quiet); if (!__1) { return _(null, __1); } ; return startCopyParams.checkExistenceOperation(destContainerOrShare, destBlobOrFile, destOption, __cb(_, __frame, 84, 69, _, true)); })(__cb(_, __frame, -1368, 17, function ___(__0, __8) { return (function __$StorageUtil_startAsyncCopy__6(__then) { if (__8) {
                                      error = new Error();
                                      error.code = "FileAlreadyExists";
                                      return _(error); } else { __then(); } ; })(function __$StorageUtil_startAsyncCopy__6() {


                                    retry = false;
                                    filePath = StorageUtil.normalizePath(destBlobOrFile);
                                    result = StorageUtil.fetchBasenameAndDirname(filePath);
                                    return StorageUtil.performStorageOperation(startOperation.operation, __cb(_, __frame, 93, 29, function ___(__0, __9) { copyOp = __9; __then(); }, true), source, destContainerOrShare, result.dirname, result.basename, startOperation.options); }); }, true)); } ; })(__then); }); })(function ___(e, __result) { __catch(function __$StorageUtil_startAsyncCopy__6() { if (e) { return (function __$StorageUtil_startAsyncCopy__6(__then) {


                                if (isCopyToBlob) { return (function __$StorageUtil_startAsyncCopy__6(__then) {
                                    if (StorageUtil.isBlobExistsException(e)) {
                                      return cli.interaction.confirm(util.format($("Do you want to overwrite the existing blob %s in the container %s? (Y/N) "), destBlobOrFile, destContainerOrShare), __cb(_, __frame, 98, 34, function ___(__0, __5) { retry = __5;
                                        e.message = util.format($("The blob %s in the container %s already exists "), destBlobOrFile, destContainerOrShare); __then(); }, true)); } else { __then(); } ; })(__then); } else { return (function __$StorageUtil_startAsyncCopy__6(__then) {


                                    if (StorageUtil.isFileExistsException(e)) {
                                      return cli.interaction.confirm(util.format($("Do you want to overwrite the existing file %s in the share %s? (Y/N) "), destBlobOrFile, destContainerOrShare), __cb(_, __frame, 103, 34, function ___(__0, __6) { retry = __6;
                                        e.message = util.format($("The file %s in the share %s already exists "), destBlobOrFile, destContainerOrShare); __then(); }, true)); } else { __then(); } ; })(__then); } ; })(function __$StorageUtil_startAsyncCopy__6() {


                                if (!retry) {
                                  return _(e); } ; __then(); }); } else { _(null, __result); } ; }, _); }); })(function ___() { __tryCatch(_, function __$StorageUtil_startAsyncCopy__6() { _(null, null, true); }); }); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$StorageUtil_startAsyncCopy__6() {


                        if (!retry) {
                          StorageUtil.endProgress(); } ; __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$StorageUtil_startAsyncCopy__6() { while (__more) { __loop(); }; __more = true; }); }); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$StorageUtil_startAsyncCopy__6() {
            ...
            cli.interaction.formatOutput(copyOp, function(outputData) {
              ...
              logger.table(output, function(row, item) {
                ...
                row.cell($("Status"), item.copyStatus); }); }); _(); }); }, true)); }, true)); }, true)); });};
...
StorageUtil.showAsyncCopy = function StorageUtil_showAsyncCopy__7(showCopyParams, containerOrShare, blobOrFilePath, options, _) { var isCopyToBlob, destOption, blobOrFileProps; var __frame = { name: "StorageUtil_showAsyncCopy__7", line: 1498 }; return __func(_, this, arguments, StorageUtil_showAsyncCopy__7, 4, __frame, function __$StorageUtil_showAsyncCopy__7() {
            ...
            cli.interaction.formatOutput(blobOrFileProps, function(outputData) {
              ...
              logger.table(output, function(row, item) {
                ...
                if (item.copyStatusDescription) {
                  row.cell($("Description"), item.copyStatusDescription); } ; }); }); } ; _(); }, true)); }, true)); }, true)); });};
...
StorageUtil.stopAsyncCopy = function StorageUtil_stopAsyncCopy__8(stopCopyParam, containerOrShare, blobOrFilePath, copyid, options, _) { var isCopyToBlob, serviceClient, stopOperation, tips, stopOp, filePath, result; var __frame = { name: "StorageUtil_stopAsyncCopy__8", line: 1527 }; return __func(_, this, arguments, StorageUtil_stopAsyncCopy__8, 5, __frame, function __$StorageUtil_stopAsyncCopy__8() {
    ...
    return cli.interaction.promptIfNotGiven((isCopyToBlob ? $("Destination container: ") : $("Destination share: ")), containerOrShare, __cb(_, __frame, 3, 37, function ___(__0, __1) { containerOrShare = __1;
      return cli.interaction.promptIfNotGiven((isCopyToBlob ? $("Destination blob: ") : $("Destination file path: ")), blobOrFilePath, __cb(_, __frame, 4, 35, function ___(__0, __2) { blobOrFilePath = __2;
        return cli.interaction.promptIfNotGiven($("Copy ID: "), copyid, __cb(_, __frame, 5, 27, function ___(__0, __3) { copyid = __3;
          ...
          StorageUtil.startProgress(tips); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$StorageUtil_stopAsyncCopy__8() { return (function __$StorageUtil_stopAsyncCopy__8(__then) {
                  ...
                  if (isCopyToBlob) {
                    ...
                    result = StorageUtil.fetchBasenameAndDirname(filePath);
                    return StorageUtil.performStorageOperation(stopOperation.operation, __cb(_, __frame, 25, 27, function ___(__0, __5) { stopOp = __5; __then(); }, true), containerOrShare, result.dirname, result.basename, copyid, stopOperation.options); } ; })(function __$StorageUtil_stopAsyncCopy__8() { _(null, null, true); }); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$StorageUtil_stopAsyncCopy__8() {


                  StorageUtil.endProgress(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$StorageUtil_stopAsyncCopy__8() {
...
function getSourceUri(type, options, _) { var isSourceDefined, source, host, settings, sourceContainerOrShare, sourceBlobOrFilePath, encode; var __frame = { name: "getSourceUri", line: 1667 }; return __func(_, this, arguments, getSourceUri, 2, __frame, function __$getSourceUri() {
    ...
    isSourceDefined = (options.isSourceBlobDefined || options.isSourceFileDefined); return (function __$getSourceUri(__then) {
      ...
      if (!isSourceDefined) {
        ...
        settings = getStorageServiceSettings(options); return (function __$getSourceUri(__then) {
          ...
          source += encode(sourceBlobOrFilePath); __then(); }); } ; })(function __$getSourceUri() {
...
function getSourceSASToken(getSourceSASParams, sourceContainerOrShare, sourceBlobOrFilePath, embeddedSas, options, _) { var sasToken, isNameDefined, isKeyDefined, isConnectionStringDefined, sourcebServiceClient, aclOperation, permission, criteria, sharedAccessPolicy, filePath, result; var __frame = { name: "getSourceSASToken", line: 1736 }; return __func(_, this, arguments, getSourceSASToken, 5, __frame, function __$getSourceSASToken() {
