...
<html lang="en">
<head>
    <title>Code coverage report for lib\services\table\models\entityresult.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\services\table\models\entityresult.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">lib/services/table/models/</a> &#187; entityresult.js</div>
</div>
<div class="body">
...
exports.parseQuery = function (response, autoResolveProperties, propertyResolver, entityResolver) {
  var result = {};
  <span class="missing-if-branch" title="else path not taken" >E</span>if (response.body) {
