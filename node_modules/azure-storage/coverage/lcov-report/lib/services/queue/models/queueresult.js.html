...
<html lang="en">
<head>
    <title>Code coverage report for lib\services\queue\models\queueresult.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\services\queue\models\queueresult.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">lib/services/queue/models/</a> &#187; queueresult.js</div>
</div>
<div class="body">
...
QueueResult.parse = function (messageXml) {
  ...
  for (var property in messageXml) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (messageXml.hasOwnProperty(property)) {
...
&nbsp;
module.exports = QueueResult;</pre></td></tr>
</table></pre>
