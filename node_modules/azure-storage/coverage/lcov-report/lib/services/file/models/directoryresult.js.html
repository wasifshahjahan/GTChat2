...
<html lang="en">
<head>
    <title>Code coverage report for lib\services\file\models\directoryresult.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\services\file\models\directoryresult.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">lib/services/file/models/</a> &#187; directoryresult.js</div>
</div>
<div class="body">
...
&nbsp;
  var setDirectoryPropertyFromHeaders = function (directoryProperty, headerProperty) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!self[directoryProperty] &amp;&amp; headers[headerProperty.toLowerCase()]) {
...
&nbsp;
module.exports = DirectoryResult;</pre></td></tr>
</table></pre>
