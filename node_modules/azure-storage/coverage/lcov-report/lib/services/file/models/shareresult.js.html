...
<html lang="en">
<head>
    <title>Code coverage report for lib\services\file\models\shareresult.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\services\file\models\shareresult.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">lib/services/file/models/</a> &#187; shareresult.js</div>
</div>
<div class="body">
...
ShareResult.parse = function (shareXml, name) {
  ...
  for (var propertyName in shareXml) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (shareXml.hasOwnProperty(propertyName)) {
      if (propertyName === 'Properties' || propertyName === 'Metadata' || propertyName === 'ShareStats') {
        ...
        for (var subPropertyName in shareXml[propertyName]) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (shareXml[propertyName].hasOwnProperty(subPropertyName)) {
...
&nbsp;
module.exports = ShareResult;</pre></td></tr>
</table></pre>
