...
<html lang="en">
<head>
    <title>Code coverage report for lib\services\blob\blobservice.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib\services\blob\blobservice.js</span></h1>
    <h2>
        Statements: <span class="metric">92.99% <small>(1646 / 1770)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">72.22% <small>(390 / 540)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">96.71% <small>(323 / 334)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">92.68% <small>(1533 / 1654)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">lib/services/blob/</a> &#187; blobservice.js</div>
</div>
<div class="body">
...
5581
5582
5583</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  var processResponseCallback = function (responseObject, next) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!responseObject.error) {
...
<span class="cstat-no" title="statement not covered" >      callback(error, exists, response);</span>
    } else if (exists) {
      ...
      self.createContainer(container, options, function (createError, responseContainer, createResponse) {
        ...
        else <span class="missing-if-branch" title="if path not taken" >I</span>if (createError &amp;&amp; createError.statusCode === Constants.HttpConstants.HttpResponseCodes.Conflict &amp;&amp; createError.code === Constants.BlobErrorCodeStrings.CONTAINER_ALREADY_EXISTS) {
          // If it was created before, there was no actual error.
<span class="cstat-no" title="statement not covered" >          createError = null;</span>
<span class="cstat-no" title="statement not covered" >          created = false;</span>
...
&nbsp;
  ...
  if (signedIdentifiers) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isArray(signedIdentifiers)) {
<span class="cstat-no" title="statement not covered" >      throw new Error(SR.INVALID_SIGNED_IDENTIFIERS);</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      callback(error, exists, response);</span>
      ...
      self.deleteContainer(container, options, function (deleteError, deleteResponse) {
        var deleted;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!deleteError) {
          deleted = true;
...
&nbsp;
  ...
  this.getBlobProperties(container, blob, propertiesRequestOptions, function (error, properties) {
    if (error) {
      ...
      var size;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (options.rangeStart) {
...
&nbsp;
  ...
  var webResource = WebResource.del(resourceName)
    .withHeader(HeaderConstants.LEASE_ID, options.leaseId);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!azureutil.objectIsNull(options.snapshotId) &amp;&amp; !azureutil.objectIsNull(options.deleteSnapshots)) {
<span class="cstat-no" title="statement not covered" >    throw new Error(SR.INVALID_DELETE_SNAPSHOT_OPTION);</span>
  }
...
&nbsp;
  var processResponseCallback = function (responseObject, next) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!responseObject.error) {
      ...
      responseObject.blobResult.getPropertiesFromHeaders(responseObject.response.headers);
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (options.metadata) {
...
BlobService.prototype.generateSharedAccessSignature = function (container, blob, sharedAccessPolicy, headers) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.storageCredentials || !this.storageCredentials.generateSignedQueryString) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (blob) {
    validate.validateArgs('generateSharedAccessSignature', function (v) {
      v.string(blob, 'blob');
    });
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (sharedAccessPolicy.AccessPolicy) {
    if (!azureutil.objectIsNull(sharedAccessPolicy.AccessPolicy.Start)) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isDate(sharedAccessPolicy.AccessPolicy.Start)) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!azureutil.objectIsNull(sharedAccessPolicy.AccessPolicy.Expiry)) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isDate(sharedAccessPolicy.AccessPolicy.Expiry)) {
...
&nbsp;
  var host;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!azureutil.objectIsNull(primary) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >primary === false)</span> {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (length &amp;&amp; length % BlobConstants.PAGE_SIZE !== 0) {
<span class="cstat-no" title="statement not covered" >    throw new Error(SR.INVALID_PAGE_BLOB_LENGTH);</span>
  }
&nbsp;
  var options = extend(true, {}, userOptions);
&nbsp;
...
&nbsp;
  var options = extend(true, {}, userOptions);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if ((rangeEnd - rangeStart) + 1 &gt; BlobConstants.MAX_UPDATE_PAGE_SIZE) {
<span class="cstat-no" title="statement not covered" >    throw new Error(SR.INVALID_PAGE_RANGE_FOR_UPDATE);</span>
  }
&nbsp;
  var self = this;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.rangeStart &amp;&amp; options.rangeStart % BlobConstants.PAGE_SIZE !== 0) {
<span class="cstat-no" title="statement not covered" >    throw new Error(SR.INVALID_PAGE_START_OFFSET);</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.rangeEnd &amp;&amp; (options.rangeEnd + 1) % BlobConstants.PAGE_SIZE !== 0) {
<span class="cstat-no" title="statement not covered" >    throw new Error(SR.INVALID_PAGE_END_OFFSET);</span>
  }
&nbsp;
  BlobResult.setHeadersFromBlob(webResource, options);
&nbsp;
...
&nbsp;
  ...
  var webResource = WebResource.put(resourceName)
    .withQueryOption(QueryStringConstants.COMP, 'properties');
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (size &amp;&amp; size % BlobConstants.PAGE_SIZE !== 0) {
<span class="cstat-no" title="statement not covered" >    throw new Error(SR.INVALID_PAGE_BLOB_LENGTH);</span>
  }
&nbsp;
...
&nbsp;
  var options = extend(true, {}, userOptions);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (streamLength &gt; BlobConstants.MAX_BLOCK_SIZE) {
<span class="cstat-no" title="statement not covered" >    throw new Error(SR.INVALID_STREAM_LENGTH);</span>
  } else {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (contentLength &gt; BlobConstants.MAX_BLOCK_SIZE) {
<span class="cstat-no" title="statement not covered" >    throw new Error(SR.INVALID_TEXT_LENGTH);</span>
  } else {
...
&nbsp;
  ...
  var creationCallback = function (createError, createBlob, createResponse) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (createError) {
...
&nbsp;
  if (blobType === BlobConstants.BlobTypes.BLOCK) {
    // default to true, unless explicitly set to false
    options.storeBlobContentMD5 = options.storeBlobContentMD5 === false ? <span class="branch-0 cbranch-no" title="branch not covered" >false </span>: true;
  }
&nbsp;
  stream.pause();
&nbsp;
...
&nbsp;
  if (!isNewBlob) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.storeBlobContentMD5 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >blobType !== BlobConstants.BlobTypes.BLOCK </span>) {
<span class="cstat-no" title="statement not covered" >      throw new Error(SR.MD5_NOT_POSSIBLE);</span>
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (blobType === BlobConstants.BlobTypes.APPEND || (<span class="branch-1 cbranch-no" title="branch not covered" >options.accessConditions </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >options.accessConditions.length &gt; 0)</span>) {
...
<span class="cstat-no" title="statement not covered" >          callback(error);</span>
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (blobType === BlobConstants.BlobTypes.APPEND) {
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (length &gt; BlobConstants.MAX_SINGLE_UPLOAD_BLOB_SIZE_IN_BYTES) {
<span class="cstat-no" title="statement not covered" >        throw new Error(SR.INVALID_BLOB_LENGTH);</span>
      }
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (blobType === BlobConstants.BlobTypes.APPEND) {
      operationFunc = self._appendBlock;
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (length &gt; BlobConstants.MAX_BLOCK_SIZE) {
<span class="cstat-no" title="statement not covered" >        throw new Error(SR.INVALID_TEXT_LENGTH);</span>
      }
    }
&nbsp;
...
BlobService.prototype._putBlockBlob = function (container, blob, text, stream, length, options, callback) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.speedSummary) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!azureutil.objectIsNull(text) &amp;&amp; azureutil.objectIsNull(options.contentMD5) &amp;&amp; options.useTransactionalMD5) {
...
BlobService.prototype._updatePageBlobPagesImpl = function (container, blob, rangeStart, rangeEnd, writeMethod, options) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (rangeStart &amp;&amp; rangeStart % BlobConstants.PAGE_SIZE !== 0) {
<span class="cstat-no" title="statement not covered" >    throw new Error(SR.INVALID_PAGE_START_OFFSET);</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (rangeEnd &amp;&amp; (rangeEnd + 1) % BlobConstants.PAGE_SIZE !== 0) {
<span class="cstat-no" title="statement not covered" >    throw new Error(SR.INVALID_PAGE_END_OFFSET);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    var error = new Error(util.format('Unknown blob type %s', blobType));</span>
<span class="cstat-no" title="statement not covered" >    callback(error);</span>
...
&nbsp;
  ...
  var speedSummary = options.speedSummary || <span class="branch-1 cbranch-no" title="branch not covered" >new SpeedSummary(blob);</span>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (chunkStream._stream &amp;&amp; chunkStream._stream.setMemoryAllocator) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (data.length &gt; sizeLimitation) {
...
&nbsp;
    var uploadPageBlobChunk = function () {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (azureutil.isBufferAllZero(data)) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (options.maxBlobSize &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >rangeOptions.appendPosition + data.length &gt; options.maxBlobSize)</span> {
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (isPageBlobUpload) {
      uploadPageBlobChunk();
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (operation) {
      full = batchOperations.addOperation(operation);
      operation = null;
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (full) {
...
&nbsp;
  var processResponseCallback = function (responseObject, next) {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (responseObject.error &amp;&amp; responseObject.error.statusCode === Constants.HttpConstants.HttpResponseCodes.NotFound) {
...
BlobService.prototype._validateLengthAndMD5 = function (options, responseObject) {
  ...
  var contentLength;
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!azureutil.objectIsNull(responseObject.response.headers[Constants.HeaderConstants.CONTENT_LENGTH])) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.disableContentMD5Validation === false &amp;&amp; options.useTransactionalMD5 === true &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >azureutil.objectIsNull(storedMD5))</span> {
...
&nbsp;
  ...
  if (azureutil.objectIsNull(responseObject.length)) {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (Buffer.isBuffer(responseObject.response.body)) {
      responseObject.length = responseObject.response.body.length;
    }
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!azureutil.objectIsNull(contentLength) &amp;&amp; responseObject.length !== contentLength) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.disableContentMD5Validation === false &amp;&amp; !azureutil.objectIsNull(storedMD5) &amp;&amp; storedMD5 !== responseObject.contentMD5) {
...
BlobService.prototype._setRangeContentMD5Header = function (webResource, options) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!azureutil.objectIsNull(options.rangeStart) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >options.useTransactionalMD5)</span> {
<span class="cstat-no" title="statement not covered" >    if (azureutil.objectIsNull(options.rangeEnd)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(util.format(SR.ARGUMENT_NULL_OR_EMPTY, options.rangeEndHeader));</span>
    }
&nbsp;
...
BlobService.prototype._getBlobToRangeStream = function (container, blob, blobType, writeStream, optionsOrCallback, callback) {
  ...
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (blobType == BlobConstants.BlobTypes.APPEND) {
...
<span class="cstat-no" title="statement not covered" >    isPageBlobDownload = false;</span>
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (blobType == BlobConstants.BlobTypes.BLOCK) {
    rangeStream = new BlockRangeStream(this, container, blob, options);
    isPageBlobDownload = false;
  } 
  
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!options.speedSummary) {
...
&nbsp;
  ...
  var md5Hash = null;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (checkMD5sum) {
...
&nbsp;
  rangeStream.on('range', function (range) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!speedSummary.totalSize) {
...
&nbsp;
    if (range.dataSize === 0) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (isPageBlobDownload) {
        ...
        var writeZeroOperation = new BatchOperation.CommonOperation(BatchOperation.noOperation, function (error) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (error) <span class="cstat-no" title="statement not covered" >return;</span>
...
<span class="cstat-no" title="statement not covered" >        self.logger.debug(util.format('Can not read %s bytes to %s bytes of blob %s', range.start, range.end, blob));</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (range.start &gt; range.end) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
    ...
    var operation = new BatchOperation.RestOperation(self, 'getBlobToText', container, blob, requestOptions, function (error, content, blobResult, response) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!error) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!bufferAvailable) {
...
<span class="cstat-no" title="statement not covered" >          batchOperations.pause();</span>
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (md5Hash) {
...
<span class="cstat-no" title="statement not covered" >      return;</span>
      ...
      writeStream.end(function () {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (writeStream.close) {
          writeStream.close();
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!savedBlobResult) {
